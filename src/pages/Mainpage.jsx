...
export const MainPage = () => {
	...
	const handleSortChange = (selectedOption) => {
		...
		if (selectedOption === "latest") {
			sortedMessages.sort((a, b) => new Date(b.dateField) - new Date(a.dateField));
		} else if (selectedOption === "oldest") {
			sortedMessages.sort((a, b) => new Date(a.dateField) - new Date(b.dateField));
		}
	...
	return (
		<div className="h-auto md:h-fit lg:h-screen relative">
			<div className="p-2 lg:px-56 pb-32">
				...
				<div className="flex items-center mt-3 px-3 md:px-0">
					<div className="flex items-center">
						<MessageCount count={count} />
					</div>
					<div className="flex items-center gap-5">
						<h1 className="text-sm text-gray-500">Sort Messages</h1>
